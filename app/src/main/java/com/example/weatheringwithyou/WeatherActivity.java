...
import com.example.weatheringwithyou.gson.AQI;
import com.example.weatheringwithyou.gson.Weather;
import com.example.weatheringwithyou.service.AutoUpdateService;
import com.example.weatheringwithyou.util.HttpUtil;
import java.io.IOException;
import okhttp3.Call;
import okhttp3.Callback;
import okhttp3.Response;

import static com.example.weatheringwithyou.util.Utility.handleAQIResponse;
import static com.example.weatheringwithyou.util.Utility.handleWeatherResponse;
...
//        String aqiString=prefs.getString("aqi",null);           //做了更改！！！！！！！！！！！！！！！！！！！原注释

        if(weatherString!=null)
        {
            //有缓存时直接解析天气数据
            Weather weather= (Weather) handleWeatherResponse(weatherString);
            assert weather != null;                               //断言值为非空，断言的意义只是为了省个if吗
    ...
    {
        final String weatherUrl="https://free-api.heweather.com/s6/weather?location="+weatherId.toString()+"&key=c577c587de334f2c81d8857a7bbf8453";
        final String aqiUrl="https://free-api.heweather.com/s6/air/now?location="+weatherId.toString()+"&key=c577c587de334f2c81d8857a7bbf8453";
